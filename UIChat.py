...
def recognize_speech():
    ...
    with sr.Microphone() as source:
        st.info("🎤 Listening... finish in max 5 sec")
...
st.title("ChatBot from imademethink")

# === Sidebar System Prompt ===
with st.sidebar:
    st.subheader("🤖 Bot Personality")
    system_prompt = st.text_area("Set system prompt (personality)", value="You are a helpful, professional, concise assistant.")
